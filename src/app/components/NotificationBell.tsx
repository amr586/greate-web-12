...
import { Bell, X, CheckCheck, MessageSquare, Home, CreditCard, Headphones, Info, Mail } from 'lucide-react';
...
function notifIcon(type: string) {
  ...
  if (type === 'contact_message' || type === 'contact') return <Mail size={14} />;
...
function notifColor(type: string) {
  ...
  if (type === 'contact_message' || type === 'contact') return 'bg-cyan-100 text-cyan-700';
