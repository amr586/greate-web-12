    ...
    <div className="min-h-screen bg-gray-50 pt-20" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#005a7d] to-[#007a9a] rounded-2xl p-5 mb-8 flex flex-wrap items-center gap-4"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-bold text-sm">طرق الدفع المتاحة</p>
              <p className="text-white/80 text-xs">InstaPay · فودافون كاش</p>
            </div>
          </div>
          <div className="h-8 w-px bg-white/30 hidden sm:block" />
          <div>
            <p className="text-white/80 text-xs mb-0.5">رقم المحفظة</p>
            <p className="text-white font-black text-lg" dir="ltr">{COMPANY_PHONE}</p>
          </div>
          <div className="h-8 w-px bg-white/30 hidden sm:block" />
          <a href={`tel:+2${COMPANY_PHONE}`} className="flex items-center gap-2 bg-white/20 hover:bg-white/30 transition-colors px-4 py-2 rounded-xl text-white text-sm font-bold">
            <Phone size={15} />
            {COMPANY_PHONE}
          </a>
          <a href={`https://wa.me/2${COMPANY_PHONE}`} target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 bg-green-500 hover:bg-green-600 transition-colors px-4 py-2 rounded-xl text-white text-sm font-bold mr-auto"
          >
